...
public class Main {
    public static void main(String[] args) {
        ...
        int x1 = point1.getX();
        int y1 = point1.getY();
        System.out.println("Координати точок: (" + x1 + ", " + y1 + ")");

        point1.setX(5);
        point1.setY(7);
        System.out.println("Змінені координати: (" + point1.getX() + ", " + point1.getY() + ")");
        ...
        System.out.println("Відстань між точкою 1 та 2: " + distanceBetween);

        boolean equal = point1.isEqualTo(point2);
